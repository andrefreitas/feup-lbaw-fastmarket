...
VALUES('David Smith','david@gmail.com','d35aa290d06ae9cb981c71250356ce6d415a4e9299500dd2742cdbac5ef78b12',1);
/* MERCHANT - Password: Kl6jfuig */
INSERT INTO users(name,email,password,privilege_id) 
VALUES('Peter Griffin','peter@gmail.com','7fe0eb49c3719f1b97142c1e7bb9f91706d3e2a9167e271fda8b3d7545389cfe',2);
/* COSTUMER - Password: k8h3ugfs */
INSERT INTO users(name,email,password,privilege_id) 
VALUES('Sophie Adams','sophie@yahoo.com','a8c3210a0bb31d22b8bb0964ce4a9b3a556d98783b21bd2e787c355efbbad05c',3);
/* COSTUMER - Password: sdtg73oig3 */
INSERT INTO users(name,email,password,privilege_id) 
VALUES('Tony Perry','tony@yahoo.com','bc9d5178b8686a89052bc0b5f5af6a461ed034140e08bf07c4b8ff43477cfa46',3);
...
/* Stores */
INSERT INTO stores(name,slogan,vat,logo_id) VALUES('Lux Cars','Cars have value',0.23,1);
...
VALUES('BMW Serie 1','Low budget, a big car.',24000,2,1);
INSERT INTO products(name,description,base_cost,stock,category_id) 
VALUES('BMW Serie 3','Your rocket to travel the world',54000,1,1);
INSERT INTO products(name,description,base_cost,stock,category_id) 
VALUES('458 Italia','400 horse power in a red car',120000,10,2);
